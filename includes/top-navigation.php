                            ...
                            <ul class="navbar-nav navbar-nav-hover ms-auto">
                                ...
                                <li class="nav-item my-auto ms-3 ms-lg-0">
                                    <a class="nav-link ps-2 d-flex cursor-pointer align-items-center" id="dropdownMenuUser" data-bs-toggle="dropdown" aria-expanded="false">
                                        <span style="display:none;"><img src="<?= validate_image($_settings->userdata('avatar')) ?>" alt="<?= $_settings->userdata('firstname') ?> Image" class="image-user img-thumbnail rounded-circle"></span>
                                        Howdy, <?=$_settings->userdata('firstname')?>
                                    </a>
                                </li>
